    ...
    public static void main(String[] args) throws IOException {
        ...
        for(int i=0; i<graphList.size(); i++){
            for(int j= i+1; j<graphList.size(); j++){
                ...
                SimpleWeightedGraph<WindowEdge, DefaultWeightedEdge> biPartitieGraph = new SimpleWeightedGraph<WindowEdge, DefaultWeightedEdge>
                	(new ClassBasedEdgeFactory<WindowEdge, DefaultWeightedEdge>(DefaultWeightedEdge.class));
